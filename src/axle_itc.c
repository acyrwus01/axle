...
void* runningQueue(void* arg)
{
    ...
    while(itc_exit == RUNNING) {
        ...
        for(u16 i = 0; i < msgQueueSize; ++i)
            for(u16 j = 0; j < recieverQueueSize; ++j)
